...
tk.set_appearance_mode("dark")  # หรือ "light"
tk.set_default_color_theme("blue")  # หรือ "green", "dark-blue"
...
class Application(tk.CTk):
    ...
    def login_screen(self):
        ...
        label_title = tk.CTkLabel(self, text="ระบบลงทะเบียนเรียนของนักศึกษา", font=("Arial", 20))
        label_title.pack(pady=20)

        frame = tk.CTkFrame(self)
        frame.pack(pady=10)

        label_role = tk.CTkLabel(frame, text="เข้าสู่ระบบในฐานะ")
        ...
        radio_admin = tk.CTkRadioButton(frame, text="Admin", variable=self.role_var, value="Admin")
        radio_admin.grid(row=0, column=2, padx=5, pady=5)

        label_id = tk.CTkLabel(frame, text="User ID")
        label_id.grid(row=1, column=0, padx=5, pady=5)

        self.entry_id = tk.CTkEntry(frame)
        self.entry_id.grid(row=1, column=1, padx=5, pady=5)

        label_password = tk.CTkLabel(frame, text="Password")
        label_password.grid(row=2, column=0, padx=5, pady=5)

        self.entry_password = tk.CTkEntry(frame, show='*')
        self.entry_password.grid(row=2, column=1, padx=5, pady=5)

        btn_login = tk.CTkButton(self, text="เข้าสู่ระบบ", command=self.login)
    ...
    def show_enrollments(self):
        ...
        label = tk.CTkLabel(self, text="ข้อมูลการลงทะเบียนเรียนของคุณ", font=("Arial", 16))
        label.pack(pady=10)
        ...
        btn_add_course = tk.CTkButton(btn_frame, text="Add รายวิชา", command=self.add_courses)
        btn_add_course.grid(row=0, column=0, padx=5)

        btn_logout = tk.CTkButton(btn_frame, text="Logout", command=self.logout)
    ...
    def show_all_enrollments(self):
        ...
        label = tk.CTkLabel(self, text="ข้อมูลการลงทะเบียนของนักศึกษาทุกคน", font=("Arial", 16))
        label.pack(pady=10)
        ...
        btn_manage_data = tk.CTkButton(btn_frame, text="Manage Data", command=self.manage_data)
    ...
    def add_courses(self):
        ...
        label = tk.CTkLabel(self, text="เลือกวิชาที่ต้องการเพิ่ม (สูงสุด 3 วิชา)", font=("Arial", 16))
        label.pack(pady=10)
        ...
        self.entry_courses = tk.CTkEntry(self)
        self.entry_courses.pack()

        btn_frame = tk.CTkFrame(self)
        btn_frame.pack(pady=10)

        btn_submit = tk.CTkButton(btn_frame, text="Submit", command=self.submit_courses)
        btn_submit.grid(row=0, column=0, padx=5)

        if self.user_role == 'Admin':
            btn_back = tk.CTkButton(btn_frame, text="ย้อนกลับ", command=self.show_all_enrollments)
        else:
            btn_back = tk.CTkButton(btn_frame, text="ย้อนกลับ", command=self.show_enrollments)
    ...
    def manage_data(self):
        ...
        label = tk.CTkLabel(self, text="Manage Data", font=("Arial", 16))
        label.pack(pady=10)

        btn_frame = tk.CTkFrame(self)
        btn_frame.pack(pady=10)

        btn_add = tk.CTkButton(btn_frame, text="Add Data", command=self.add_data_screen)
        btn_add.grid(row=0, column=0, padx=5)

        btn_update = tk.CTkButton(btn_frame, text="Update Data", command=self.update_data_screen)
        btn_update.grid(row=0, column=1, padx=5)

        btn_delete = tk.CTkButton(btn_frame, text="Delete Data", command=self.delete_data_screen)
        btn_delete.grid(row=0, column=2, padx=5)

        btn_back = tk.CTkButton(self, text="ย้อนกลับ", command=self.show_all_enrollments)
    ...
    def add_data_screen(self):
        ...
        label = tk.CTkLabel(self, text="Add Data", font=("Arial", 16))
        label.pack(pady=10)

        label_table = tk.CTkLabel(self, text="Table Name:")
        label_table.pack()

        self.entry_table = tk.CTkEntry(self)
        self.entry_table.pack()

        btn_load = tk.CTkButton(self, text="Load Table", command=self.load_table_for_add)
        btn_load.pack(pady=5)

        btn_back = tk.CTkButton(self, text="ย้อนกลับ", command=self.manage_data)
    ...
    def load_table_for_add(self):
        ...
        label = tk.CTkLabel(self, text=f"Add Data to {table_name}", font=("Arial", 16))
        label.pack(pady=10)
        ...
        for idx, col in enumerate(columns):
            label_col = tk.CTkLabel(frame_entries, text=col)
            label_col.grid(row=0, column=idx, padx=5, pady=5)
            entry = tk.CTkEntry(frame_entries)
        ...
        btn_submit = tk.CTkButton(btn_frame, text="Add Data", command=lambda: self.add_data(table_name, columns))
        btn_submit.grid(row=0, column=0, padx=5)

        btn_back = tk.CTkButton(btn_frame, text="ย้อนกลับ", command=self.add_data_screen)
        btn_back.grid(row=0, column=1, padx=5)
    ...
    def update_data_screen(self):
        ...
        label = tk.CTkLabel(self, text="Update Data", font=("Arial", 16))
        label.pack(pady=10)
        ...
        btn_load = tk.CTkButton(self, text="Load Table", command=self.load_table_for_update)
        btn_load.pack(pady=5)
    ...
    def load_table_for_update(self):
        ...
        label = tk.CTkLabel(self, text=f"Update Data in {table_name}", font=("Arial", 16))
        label.pack(pady=10)
        ...
        label_condition = tk.CTkLabel(self, text="Conditions (เช่น column1=value1 AND column2=value2):")
        label_condition.pack(pady=5)

        self.entry_condition = tk.CTkEntry(self)
        self.entry_condition.pack()

        btn_frame = tk.CTkFrame(self)
        btn_frame.pack(pady=10)

        btn_submit = tk.CTkButton(btn_frame, text="Update Data", command=lambda: self.update_data(table_name))
        btn_submit.grid(row=0, column=0, padx=5)

        btn_back = tk.CTkButton(btn_frame, text="ย้อนกลับ", command=self.update_data_screen)
        btn_back.grid(row=0, column=1, padx=5)
    ...
    def delete_data_screen(self):
        ...
        label = tk.CTkLabel(self, text="Delete Data", font=("Arial", 16))
        label.pack(pady=10)
        ...
        btn_load = tk.CTkButton(self, text="Load Table", command=self.load_table_for_delete)
        btn_load.pack(pady=5)
    ...
    def load_table_for_delete(self):
        ...
        label = tk.CTkLabel(self, text=f"Delete Data from {table_name}", font=("Arial", 16))
        label.pack(pady=10)
        ...
        label_condition = tk.CTkLabel(self, text="Condition (เช่น column=value):")
        label_condition.pack(pady=5)
        ...
        btn_submit = tk.CTkButton(btn_frame, text="Delete Data", command=lambda: self.delete_data(table_name))
        btn_submit.grid(row=0, column=0, padx=5)

        btn_back = tk.CTkButton(btn_frame, text="ย้อนกลับ", command=self.delete_data_screen)
        btn_back.grid(row=0, column=1, padx=5)
