...
# Function to play click sound using pygame
def play_click_sound():
    def play_sound():
        try:
            pygame.mixer.init()
            pygame.mixer.music.load('click.mp3')  # ใช้ไฟล์เสียงที่คุณเตรียมไว้
...
class Application(tk.CTk):
    ...
    def login_screen(self):
        ...
        btn_login = tk.CTkButton(
            self,
            text="Login",
            command=lambda: [play_click_sound(), self.login()],
            font=("Arial", 16)
        )
        btn_login.pack(pady=10)

        btn_fullscreen = tk.CTkButton(
            self,
            text="Full Screen",
            command=self.toggle_fullscreen,  # play_click_sound() ถูกเรียกใน toggle_fullscreen
            font=("Arial", 16)
        )
    ...
    def show_enrollments(self):
        ...
        btn_add_course = tk.CTkButton(
            btn_frame,
            text="Add Courses",
            command=lambda: [play_click_sound(), self.add_courses()],
            font=("Arial", 16)
        )
        btn_add_course.grid(row=0, column=0, padx=5)

        btn_logout = tk.CTkButton(
            btn_frame,
            text="Logout",
            command=lambda: [play_click_sound(), self.logout()],
            font=("Arial", 16)
        )
    ...
    def show_all_enrollments(self):
        ...
        btn_manage_data = tk.CTkButton(
            btn_frame,
            text="Manage Data",
            command=lambda: [play_click_sound(), self.manage_data()],
            font=("Arial", 16)
        )
    ...
    def add_courses(self):
        ...
        btn_submit = tk.CTkButton(
            btn_frame,
            text="Submit",
            command=lambda: [play_click_sound(), self.submit_courses()],
            font=("Arial", 16)
        )
        btn_submit.grid(row=0, column=0, padx=5)

        if self.user_role == 'Admin':
            btn_back = tk.CTkButton(
                btn_frame,
                text="Back",
                command=lambda: [play_click_sound(), self.show_all_enrollments()],
                font=("Arial", 16)
            )
        else:
            btn_back = tk.CTkButton(
                btn_frame,
                text="Back",
                command=lambda: [play_click_sound(), self.show_enrollments()],
                font=("Arial", 16)
            )
    ...
    def manage_data(self):
        ...
        btn_add = tk.CTkButton(
            btn_frame,
            text="Add Data",
            command=lambda: [play_click_sound(), self.add_data_screen()],
            font=("Arial", 16)
        )
        btn_add.grid(row=0, column=0, padx=5)

        btn_update = tk.CTkButton(
            btn_frame,
            text="Update Data",
            command=lambda: [play_click_sound(), self.update_data_screen()],
            font=("Arial", 16)
        )
        ...
        btn_delete = tk.CTkButton(
            btn_frame,
            text="Delete Data",
            command=lambda: [play_click_sound(), self.delete_data_screen()],
            font=("Arial", 16)
        )
    ...
    def add_data_screen(self):
        ...
        btn_load = tk.CTkButton(
            self,
            text="Load Table",
            command=lambda: [play_click_sound(), self.load_table_for_add()],
            font=("Arial", 16)
        )
    ...
    def load_table_for_add(self):
        ...
        btn_submit = tk.CTkButton(
            btn_frame,
            text="Add Data",
            command=lambda: [play_click_sound(), self.add_data(table_name, columns)],
            font=("Arial", 16)
        )
        btn_submit.grid(row=0, column=0, padx=5)
    ...
    def update_data_screen(self):
        ...
        btn_load = tk.CTkButton(
            self,
            text="Load Table",
            command=lambda: [play_click_sound(), self.load_table_for_update()],
            font=("Arial", 16)
        )
        btn_load.pack(pady=5)
    ...
    def load_table_for_update(self):
        ...
        label_condition = tk.CTkLabel(
            self,
            text="Please specify the condition (e.g., student_id=6705177 AND course_id=10122):",
            font=("Arial", 16)
        )
        ...
        btn_submit = tk.CTkButton(
            btn_frame,
            text="Update Data",
            command=lambda: [play_click_sound(), self.update_data(table_name)],
            font=("Arial", 16)
        )
        btn_submit.grid(row=0, column=0, padx=5)
    ...
    def delete_data_screen(self):
        ...
        btn_load = tk.CTkButton(
            self,
            text="Load Table",
            command=lambda: [play_click_sound(), self.load_table_for_delete()],
            font=("Arial", 16)
        )
        btn_load.pack(pady=5)
    ...
    def load_table_for_delete(self):
        ...
        label_condition = tk.CTkLabel(
            self,
            text="Condition (e.g., column=value):",
            font=("Arial", 16)
        )
        label_condition.pack(pady=5)
        ...
        btn_submit = tk.CTkButton(
            btn_frame,
            text="Delete Data",
            command=lambda: [play_click_sound(), self.delete_data(table_name)],
            font=("Arial", 16)
        )
        btn_submit.grid(row=0, column=0, padx=5)
